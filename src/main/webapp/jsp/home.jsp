					...
					<c:forEach items="${faculties}" var="currentFaculty">
						...
						<div class="w3-card-4" style="width: 20%; margin: 2%">
							...
							<a
								...
								class="btn btn-primary"><spring:message code='home.choose_this_faculty'/></a> <a
								href="showHappyStudents?currentFacultyId=${currentFaculty.id}"><spring:message code='home.future_students'/></a>
